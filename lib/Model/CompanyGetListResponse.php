...
/**
 * CompanyGetListResponse Class Doc Comment
 *
 * @category Class
 * @description company.get.list.response
 * @package  Vgrish\YclientsOpenApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CompanyGetListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'company_get_list_response';
    ...
    */
     ...
     * Sets data
     *
     * @param \Vgrish\YclientsOpenApi\Model\CompanyResponse[] $data Данные
     *
     * @return self
     */
