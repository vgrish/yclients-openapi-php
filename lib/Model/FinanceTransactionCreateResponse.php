...
/**
 * FinanceTransactionCreateResponse Class Doc Comment
 *
 * @category Class
 * @description finance.transaction.create.response
 * @package  Vgrish\YclientsOpenApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class FinanceTransactionCreateResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'finance_transaction_create_response';
