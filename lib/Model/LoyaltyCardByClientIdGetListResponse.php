...
/**
 * LoyaltyCardByClientIdGetListResponse Class Doc Comment
 *
 * @category Class
 * @description loyalty.card.byClientId.get.list.response
 * @package  Vgrish\YclientsOpenApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class LoyaltyCardByClientIdGetListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'loyalty_card_byClientId_get_list_response';
