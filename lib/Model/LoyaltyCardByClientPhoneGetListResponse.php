...
/**
 * LoyaltyCardByClientPhoneGetListResponse Class Doc Comment
 *
 * @category Class
 * @description loyalty.card.byClientPhone.get.list.response
 * @package  Vgrish\YclientsOpenApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class LoyaltyCardByClientPhoneGetListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'loyalty_card_byClientPhone_get_list_response';
    ...
    */
     ...
     * Sets data
     *
     * @param \Vgrish\YclientsOpenApi\Model\LoyaltyCardResponse[] $data Данные
     *
     * @return self
     */
