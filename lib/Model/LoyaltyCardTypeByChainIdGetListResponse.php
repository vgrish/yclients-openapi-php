...
/**
 * LoyaltyCardTypeByChainIdGetListResponse Class Doc Comment
 *
 * @category Class
 * @description loyalty.card.type.byChainId.get.list.response
 * @package  Vgrish\YclientsOpenApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class LoyaltyCardTypeByChainIdGetListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'loyalty_card_type_byChainId_get_list_response';
