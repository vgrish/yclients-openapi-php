...
/**
 * LoyaltyCardTypeByCompanyIdGetListResponse Class Doc Comment
 *
 * @category Class
 * @description loyalty.card.type.byCompanyId.get.list.response
 * @package  Vgrish\YclientsOpenApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class LoyaltyCardTypeByCompanyIdGetListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'loyalty_card_type_byCompanyId_get_list_response';
