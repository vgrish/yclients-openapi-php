...
/**
 * LoyaltyTransactionCreateRequest Class Doc Comment
 *
 * @category Class
 * @package  Vgrish\YclientsOpenApi
 * @author   OpenAPI Generator team
 ...
 */
class LoyaltyTransactionCreateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LoyaltyTransactionCreateRequest';
    ...
    */
     ...
     * Sets amount
     *
     * @param float $amount Сумма списания/пополнения. Положительная для пополнения, отрицательная для списания.
     *
     * @return self
     */
     ...
     * Sets title
     *
     * @param string|null $title Примечание к транзакции.
     *
     * @return self
     */
